...
in the river is negligibly small, i.e. the leaves do not change their positions once they fall
in the river.
...
int main()
{
  vector<int> array({1, 3, 1, 4, 2, 3, 5, 4});
  printv(array);
  cout << solution(5, array) << endl;
}
